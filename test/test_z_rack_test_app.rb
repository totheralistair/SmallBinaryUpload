...
class TestRequests < Test::Unit::TestCase
  ...
  def test_00_can_upload_ascii_file_via_rack
    ...
    fn = '/Users/alistaircockburn/Desktop/Enviado desde mi ipad.txt'
    params = {  description: 'A text file',
                text_source: Rack::Multipart::UploadedFile.new( fn )
    }
    env = Rack::MockRequest.env_for( '/', { method: 'POST', params: params } )
    result = app.call env

    body = result[2][0]
    body.should == File.read( fn )
  end
  ...
  def test_01_can_upload_binary_file_via_rack
    ...
    app = Z_rack_test_app.new
    fn = '/Users/alistaircockburn/Desktop/2x2.png'
    params = {  description: 'A binary file',
                text_source: Rack::Multipart::UploadedFile.new( fn, "image/png", binary=true )
              }
    env = Rack::MockRequest.env_for( '/', { method: 'POST', params: params } )
    result = app.call env
    body = result[2][0]
    body.should == IO.binread( fn )
  end
